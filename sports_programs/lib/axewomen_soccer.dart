...
// This file creates the Axewomen Soccer page with tabs for
...
Future<Roster> fetchRoster() async {
  ...
  final response = await http.get(api + '/wsoccerPlayers');
...
Future<Schedule> fetchSchedule() async {
  ...
  final response = await http.get(api + '/wsoccerGames');
  if (response.statusCode == 200) {
    // If the server did return a 200 OK response,
    // then parse the JSON.
...
Future<Standings> fetchStandings() async {
  ...
  final response = await http.get(api + '/wsoccerTeams');
  if (response.statusCode == 200) {
    // If the server did return a 200 OK response,
    // then parse the JSON.
...
class AxewomenSoccerState extends State<AxewomenSoccer> {
  ...
  final urlList = [
    'https://gocapersgo.ca/sports/wsoc/2020-21/roster',
    'https://daltigers.ca/sports/wsoc/2020-21/roster',
    'https://www.goseahawks.ca/sports/wsoc/2020-21/roster',
    'https://www.umoncton.ca/umcm-sports/node/187',
    'https://mountiepride.ca/sports/wsoc/2020-21/roster',
    'https://goredsgo.ca/sports/wsoc/2020-21/roster',
    'https://gopanthersgo.ca/sports/wsoc/2020-21/roster',
    'https://www.smuhuskies.ca/sports/wsoc/2020-21/roster',
    'https://www.gotommies.ca/sports/wsoc/2020-21/roster',
    'https://www.goxgo.ca/sports/wsoc/2020-21/roster',
  ];
