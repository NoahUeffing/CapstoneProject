...
// This file creates the Axewomen Basketball page with tabs for
...
Future<Roster> fetchRoster() async {
  ...
  final response = await http.get(api + '/wbasketPlayers');
...
Future<Schedule> fetchSchedule() async {
  ...
  final response = await http.get(api + '/wbasketGames');
  if (response.statusCode == 200) {
    // If the server did return a 200 OK response,
    // then parse the JSON.
...
Future<Standings> fetchStandings() async {
  ...
  final response = await http.get(api + '/wbasketTeams');
  if (response.statusCode == 200) {
    // If the server did return a 200 OK response,
    // then parse the JSON.
...
class AxewomenBasketballState extends State<AxewomenBasketball> {
  ...
  final urlList = [
    'https://www.gocapersgo.ca/sports/wbkb/2020-21/roster',
    'https://daltigers.ca/sports/wbkb/2020-21/roster',
    'https://www.goseahawks.ca/sports/wbkb/2019-20/roster',
    'https://goredsgo.ca/sports/wbkb/2020-21/roster',
    'https://gopanthersgo.ca/sports/wbkb/2020-21/roster',
    'https://www.smuhuskies.ca/sports/wbkb/2020-21/roster',
    'https://www.goxgo.ca/sports/wbkb/2020-21/roster',
  ];
            ...
            title: RichText(
              text: TextSpan(
                children: [
                  ...
                  TextSpan(
                      text: " " + globals.womenBasketballTitle,
                      style: globals.titleFont),
                ],
              ),
            ),
