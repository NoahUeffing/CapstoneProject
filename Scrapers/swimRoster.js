...
(async () => {
  try {
    ...
    await page.goto(`https://www.acadiaathletics.ca/sports/swim/2019-20/roster`);
    ...
    var data = await page.evaluate(() => {
      ...
      var clubList = document.querySelectorAll(`#mainbody > div.mod-roster > div.roster > table > tbody > tr > td:nth-child(4)`);
      ...
      for (var i = 0; i < nameList.length; i++) {
        rosterArray[i] = {
          ...
          club: clubList[i].innerText.trim(),
    ...
    fs.writeFile("swimTeam.json", JSON.stringify(data), function (err) {
      if (err) throw err;
      console.log("Saved!");
    });
