...
(async () => {
  try {
    ...
    await page.goto(`http://www.acadiaathletics.ca/sports/wbkb/2019-20/standings`);
    ...
    await page.waitForSelector("#mainbody > div.full-standings.clearfix > div > div.overflow > div > table > tbody > tr > td:nth-child(15)");
    ...
    var data = await page.evaluate(() => {
      ...
      var ptsList = document.querySelectorAll(`#mainbody > div.full-standings.clearfix > div > div.overflow > div > table > tbody > tr > td:nth-child(15)`);
    ...
    fs.writeFile("wbasketStats.json", JSON.stringify(data), function(err) {
      if (err) throw err;
      console.log("Saved!");
    });
