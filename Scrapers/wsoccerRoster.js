...
(async () => {
  try {
    ...
    await page.goto(`https://www.acadiaathletics.ca/sports/wsoc/2019-20/roster`);
    ...
    var data = await page.evaluate(() => {
      ...
      var townList = document.querySelectorAll(`#mainbody > div.mod-roster > div.roster > table > tbody > tr > td:nth-child(5)`);
    ...
    fs.writeFile("wsoccerTeam.json", JSON.stringify(data), function (err) {
      if (err) throw err;
      console.log("Saved!");
    });
